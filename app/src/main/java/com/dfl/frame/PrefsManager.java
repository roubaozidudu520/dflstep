...
public class PrefsManager {
    ...
    private static final String PERFERENCE_NAME = "dfl_step";
    ...
    public void clear()
    {
        mContext.getSharedPreferences(PrefsManager.PERFERENCE_NAME, Context.MODE_PRIVATE).edit().clear().commit();
    }
    ...
    {
        return this.mContext.getSharedPreferences(PrefsManager.PERFERENCE_NAME,
